...
public class DAOHelper extends SQLiteOpenHelper implements DatabaseConstants {
	...
	protected static final String[] TEAMS_ALL_COLUMNS = new String[] { _ID,
			TEAMS_NAME };
	...
	protected static final String MEETINGS_QUICKEST_STATUS = "quickest_statuc";
	protected static final String MEETINGS_LONGEST_STATUS = "longest_status";
	protected static final String[] MEETINGS_ALL_COLUMNS = { _ID,
			MEETINGS_TEAM_NAME, MEETINGS_MEETING_TIME,
			MEETINGS_NUM_PARTICIPANTS, MEETINGS_INDIVIDUAL_STATUS_LENGTH,
			MEETINGS_MEETING_LENGTH, MEETINGS_QUICKEST_STATUS, MEETINGS_LONGEST_STATUS };
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE "+MEETINGS_TABLE_NAME+" ("
				+_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "
				+MEETINGS_TEAM_NAME+" TEXT_NOT NULL, "
